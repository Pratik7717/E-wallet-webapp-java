...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center" id="content">
            <div class="col-md-6">
                <div class="showcase-title">The new era of electronic payments</div>
                ...
                <img class="my-3" src="./images/4.svg" alt="" width="100%">
            </div>
            <div class="col-md-6 my-4">
                <form class="shadow  px-4 py-2 justify-content-center form-radius" id="form">
                    <div class="form-group col text-center">
                        <h2 class="form-header">Signup Now..</h2>
                    </div>
